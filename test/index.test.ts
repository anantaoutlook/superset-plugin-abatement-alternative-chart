 ...
 * under the License.
 */
import { SupersetPluginAbatementAlternativeChart } from '../src';
 ...
 */
describe('superset-plugin-abatement-alternative-chart', () => {
  it('exists', () => {
    expect(SupersetPluginAbatementAlternativeChart).toBeDefined();
  });
});
