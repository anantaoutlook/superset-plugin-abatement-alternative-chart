...
class SupersetPluginAbatementAlternativeChart extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    var metadata = new _core.ChartMetadata({
      description: 'Superset Plugin Abatement Alternative Chart',
      name: (0, _core.t)('Superset Plugin Abatement Alternative Chart'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../SupersetPluginAbatementAlternativeChart'))),
      metadata,
